...
A landing/info page for the IoT project "Balança Cloud" (Cloud Weight Scale), containing the main information on how this solution works, what it can provide to companies, and what technologies compose it.
